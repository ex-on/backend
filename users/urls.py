...
from .views import checkAvailableEmail, checkAvailableUsername, checkUserInfo, fcmToken, profileStats, getUserInfo, rankCardio, rankProtein, rankWeight, registerCognitoUserInfo, cognitoUserPhysicalInfo
