...
from community.views import getHotBoardPreview, getPostCommentReply, getPostPreview, getQnaAnswer, getQnaAnswerCommentReply, getQnaMain, getQnaMainSolved, getQnaMainType, getQnaMainUnsolved, postPost, postPostComment, postPostCommentReply, postQna, postQnaAnswer, postQnaAnswerComment, postQnaAnswerCommentReply
...
urlpatterns = [
    ...
    path('qnaanswer', getQnaAnswer), #qna_id
    path('qnaanswercommentreply', getQnaAnswerCommentReply), #qna_answer_id   
    ########게시물 작성###############
    path('post', postPost),
